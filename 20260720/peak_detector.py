...
class PeakDetector:
    ...
    def _evaluate_strategy(self, name: str, signals: pd.Series, 
        ...
        # ── 리스크 메트릭 일괄 산출 (Sharpe/Sortino/Calmar/Kelly/MC CI/거래비용) ──
        try:
            ...
            logger.debug(f"리스크 메트릭 산출 실패 ({name}): {e}")
