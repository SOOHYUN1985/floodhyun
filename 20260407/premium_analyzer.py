...
def generate_report(results: list, chart_files: list) -> str:
    ...
    os.makedirs('results/reports/premium', exist_ok=True)
    filename = f"results/reports/premium/괴리율분석리포트_{report_date}.md"
...
def main():
    ...
    for pair in STOCK_PAIRS:
        ...
        # 차트 생성
        os.makedirs('results/reports/premium', exist_ok=True)
        chart_path = f"results/reports/premium/괴리율_{name}_{report_date}_차트.png"
