...
# ╔══════════════════════════════════════════════════════════╗
# ║  👇 여기만 수정하면 됩니다 (FWD EPS가 바뀔 때마다)      ║
# ╚══════════════════════════════════════════════════════════╝
CURRENT_FWD_EPS = 651.4   # 12M Forward EPS (컨센서스) ← 자주 변경
CURRENT_BPS = 3749.0      # 12M Forward BPS            ← 분기별 변경
# ═══════════════════════════════════════════════════════════
...
try:
    _db_path = os.path.join(os.path.dirname(__file__), 'data', 'market_data.db')
...
def main():
    ...
    out_path = os.path.join('results', 'reports', 'backtest',
